-- Improved migration to copy missing menu item images with case-insensitive matching
...
BEGIN
  ...
  LOOP
    ...
    LOOP
      -- Find the corresponding category in the restaurant's menu using case-insensitive matching
      ...
      IF restaurant_category_id IS NOT NULL THEN
        ...
        END LOOP;
      ELSE
        RAISE NOTICE 'No matching restaurant category found for: %', cat_record.name;
      END IF;
    END LOOP;
  END LOOP;
