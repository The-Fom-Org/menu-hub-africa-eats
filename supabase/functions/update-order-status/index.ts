...
// This function uses service role to update order status
serve(async (req) => {
  ...
  try {
    ...
    const { customerToken, paymentStatus, orderStatus } = await req.json();
    ...
    console.log('Updating order status:', { customerToken, paymentStatus, orderStatus });
